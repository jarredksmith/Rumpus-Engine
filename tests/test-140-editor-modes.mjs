...
assert(/const EDITOR_MODES = \['build','scene','player','enemies','rules','kit','hud','files','settings'\];/.test(src), 'nine editor modes defined (HUD build 665, Settings build 1066)');
...
assert(/rules:\s*\['game','pickups','loot','invitems','buildmenu','logic','cutscenes'\]/.test(src), 'Gameplay tab: game + pickups + loot + invitems');
