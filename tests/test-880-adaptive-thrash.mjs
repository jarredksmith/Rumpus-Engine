...
assert(/_postRT=_compRT=_afterA=_afterB=_aoGeoRT=_aoRT=_aoRT2=_raysRT=_ssrRT=_velRT=null;   \/\/ build 880: keep _postScene/.test(src), 'disposePost drops targets only');   // build 1242: the rays target joins the list
