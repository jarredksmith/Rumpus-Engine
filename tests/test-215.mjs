...
assert(/thumb:c\.thumb\|\|'', animLib:\(typeof c\.animLib==='string' && ANIM_LIB_PACKS\[c\.animLib\]\)\?c\.animLib:'', clips:Object\.assign\(\{\}, c\.clips\|\|\{\}\), clipSpeed:Object\.assign\(\{\}, c\.clipSpeed\|\|\{\}\), clipHold:Object\.assign\(\{\}, c\.clipHold\|\|\{\}\), clipInPlace:Object\.assign\(\{\}, c\.clipInPlace\|\|\{\}\), tint:/.test(src), 'myCharCfg passes thumb + clipSpeed + clipHold + clipInPlace (build 493; animLib, build 921)');
assert(/thumb:c\.thumb\|\|'', animLib:c\.animLib\|\|'', clips:Object\.assign\(\{\},c\.clips\|\|\{\}\)/.test(src), 'roster serializes thumb (+ animLib, build 921)');
