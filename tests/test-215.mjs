...
assert(/thumb:c\.thumb\|\|'', animLib:c\.animLib\|\|'', autoRig:c\.autoRig\|\|undefined, ikHold:\(c\.ikHold===false\)\?false:true, jointFix:_sanitizeJointFix\(c\.jointFix\), clips:Object\.assign\(\{\},c\.clips\|\|\{\}\)/.test(src), 'roster serializes thumb (+ animLib 921; ikHold 937)');
