...
assert(/const handbrake=\(keys\['Space'\]\|\|keys\['KeyB'\]\|\|\(typeof padAds!=='undefined'&&padAds\)\|\|\(typeof touchAds!=='undefined'&&touchAds\)\);/.test(du), 'Space / B / LT / mobile Aim is the handbrake (build 786)');
