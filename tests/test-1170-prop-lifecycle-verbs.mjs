...
}
{
  ...
  assert(/'unlock','showprop','hideprop','moveprop','delprop','pushprop'\]\]/.test(src), 'the tag field appears for them');
  assert(/'teleport','command','moveprop','spawnprop','pushprop'\]\]/.test(src), 'and the place field for move (and spawnprop since 1216, pushprop since 1258)');
