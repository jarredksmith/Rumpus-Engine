...
assert(/let sliding=false, slideT=0, slideCD=0, _prevSlideKey=false, _slideBufT=0, _sprintGraceT=0;/.test(src), 'the buffer state exists (build 927: + sprint grace)');
...
assert(/if\(!sliding && slideCD<=0 && _slideBufT>0 && \(_sprinting \|\| _sprintGraceT>0\) && player\.onGround && wish\.lengthSq\(\)>0\.01/.test(src),
