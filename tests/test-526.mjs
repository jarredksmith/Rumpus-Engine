...
assert(/if\(heldProp\) txt = \(heldProp\.userData && heldProp\.userData\.grabLabel\) \|\| \(_pad \? '\[Y\] Drop (?:·|\\u00b7) \[RT\] Throw' : isTouch \? 'Hold USE to drop (?:·|\\u00b7) FIRE to throw' : '\[G \/ MMB\] Drop (?:·|\\u00b7) Click Throw (?:·|\\u00b7) Scroll Distance'\);/.test(ug), 'while carrying, a custom label replaces the drop/throw/scroll controls (681; touch 908; pad 934/935)');
