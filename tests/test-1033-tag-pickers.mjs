...
// ---- wiring ----
assert(/\{k:'target',l:'tag',w:80,listId:'lgTagList',ifv:\['verb',\['toggle','open','close','anim','unlock','showprop','hideprop','moveprop','delprop'\]\]\}/.test(src),   // build 1170: the prop lifecycle verbs take a tag too
