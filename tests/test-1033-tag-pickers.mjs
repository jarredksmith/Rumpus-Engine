...
assert(/if\(pm\.listId==='lgEvtList' \|\| pm\.listId==='lgVarList' \|\| pm\.listId==='lgListList'\) _lgRefreshDatalists\(\);/.test(src), 'naming a new event (or variable, build 1060) refreshes the list immediately');
