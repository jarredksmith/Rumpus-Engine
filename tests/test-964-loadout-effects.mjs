...
assert(/const wantFov = hipFov \+ \(_zoomFov - hipFov\) \* adsBlend \+ _sprintFov;/.test(src), 'zoomed fov drives the camera (plus the build 1210 sprint push, which is 0 while aiming)');
