...
assert(/const PLAYER_MODEL0 = \{ url:'', scale:1, face:0, rx:0, rz:0, yoff:0, xoff:0, zoff:0, thumb:'', animLib:'', ikHold:true, jointFix:\{\}, clips:\{ idle:'', walk:'', run:'', attack:'' \} \}/.test(src), 'player config has a clip state-map (build 919 animLib; build 937 ikHold)');
